...
<head>
    ...
    <meta name="keywords" content="vINYLhANoi" />
    <!--fonts-->
    ...
    if(isset($_GET["moiGH"]))
        ...
        function GiaTien($dongia) {
            $sResult = strval($dongia);
            $len = strlen($sResult);
        
            
            // $len = 6, ví dụ: 100000 -> 100.000
            if ($len == 6) {
                $sResult = substr_replace($sResult, '.', 3, 0);
            }
        
             // $len = 7, ví dụ: 1000000 -> 1.000.000
             else if ($len == 5) {
                $sResult = substr_replace($sResult, '.', 2, 0);
            }

            // $len = 7, ví dụ: 1000000 -> 1.000.000
            else if ($len == 7) {
                $sResult = substr_replace($sResult, '.', 4, 0);
                $sResult = substr_replace($sResult, '.', 1, 0);
            }
        
            // $len = 8, ví dụ: 10000000 -> 10.000.000
            else if ($len == 8) {
                $sResult = substr_replace($sResult, '.', 5, 0);
                $sResult = substr_replace($sResult, '.', 2, 0);
            }
    ...
    <div class="container">
        <div class="top-header-main">
            ...
            <div class="col-md-4 top-header-middle">
                <a href="index.php" ><img src="../images/logo1.png" height= "250px" alt="" /></a>
            </div>
